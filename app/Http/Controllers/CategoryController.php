...
class CategoryController extends Controller
{
    ...
    public function index(Request $request){
        ...
        $parentCategories = Category::whereNull('danh_muc_cha_id')->orderBy('ten_danh_muc')->get();
    ...
    public function store(Request $request)
    {
        ...
        // Tự động set trạng thái = active khi tạo mới
        Category::create([
    ...
    public function edit(Category $category){
        $parentCategories = Category::whereNull('danh_muc_cha_id')->where('id', '!=', $category->id)->orderBy('ten_danh_muc')->get();
        return view('categories.edit', compact('category', 'parentCategories'));
    }

    //Update - Sửa lại validate
        ...
        try {
            ...
            if (!$category->canDelete()) {
                return redirect()->route('categories.index')
                               ->with('error', 'Không thể xóa danh mục đã có giao dịch. Vui lòng vô hiệu hóa thay vì xóa.');
            }
